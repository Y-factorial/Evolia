Shader "Custom/SurfaceShader"
{
    Properties
    {
        ...
        [Toggle(_USE_INTERPORATION_TILE)] _UseInterporation ("Use Inter Poration Tile", Int) = 0
        [Toggle(_USE_INTERPORATION_VERTEX)] _UseInterporation ("Use Inter Poration Vertex", Int) = 0
